"""2022, day 23, part 1: https://adventofcode.com/2022/day/23."""
import pathlib
...
def solution(map: List[str], verbose: bool = False) -> int:
    ...
    while not complete and round_idx <= round_idx_max:
...
if __name__ == "__main__":
    ...
    print(solution(map_test))  # correct: 4005
